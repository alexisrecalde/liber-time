...
const formSchema = z.object({
  ...
  message: z.string().min(10, "Cuéntanos un poco más sobre tu necesidad"),
});
...
export default function Contact() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      ...
      description: "Nos pondremos en contacto contigo en breve para recuperar tu tiempo.",
    });
    form.reset();
  }
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-4">Hablemos de tu futuro</h2>
              <p className="text-lg text-muted-foreground">
                ¿Listo para dejar atrás las tareas manuales? Agenda una consulta gratuita de 30 minutos y descubramos dónde puedes ahorrar tiempo hoy mismo.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">+34 900 000 000</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">Madrid, España (y Remoto Mundial)</div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            placeholder="Descríbenos brevemente tu mayor dolor de cabeza operativo..." 
