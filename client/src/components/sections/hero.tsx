      ...
      <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8 animate-fade-up">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight text-foreground">
            Recupera tu recurso más valioso: <span className="text-gradient">El Tiempo.</span>
          </h1>
          
          <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
            Transformamos empresas mediante software a medida y automatización de procesos. 
            Deja de perder horas en tareas manuales y enfócate en escalar tu negocio.
          </p>
